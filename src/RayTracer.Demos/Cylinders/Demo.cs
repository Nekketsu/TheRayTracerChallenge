...
namespace RayTracer.Demos.Cylinders
{
    public class Demo : IDemo
    {
        public static int Order { get; } = 13;
        public static string Name { get; } = "Cylinders";
        ...
        public Canvas Run(int width = 100, int height = 50, ILogger logger = null)
        {
            ...
            world.Objects.AddRange(new Shape[] { room, tableLeg1, tableLeg2, tableLeg3, tableLeg4, table, cylinder });
