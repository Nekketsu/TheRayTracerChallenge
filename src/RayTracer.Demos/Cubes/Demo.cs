...
namespace RayTracer.Demos.Cubes
{
    public class Demo : IDemo
    {
        public static int Order { get; } = 12;
        public static string Name { get; } = "Cubes";
        ...
        public Canvas Run(int width = 100, int height = 50, ILogger logger = null)
        {
            ...
            {
                Transform = Matrix.Translation(0, 1, 0).Scale(2, 2, 2).Translate(-2, 5.5, -0.5),
                Material = new Material
                {
                    Color = new Color(0.05, 0.05, 0.15),
                    Specular = 1,
                    Shininess = 300,
                    Transparency = 1,
                    Reflective = 0.9,
            ...
            world.Objects.AddRange(new Shape[] { room, tableLeg1, tableLeg2, tableLeg3, tableLeg4, table, sphere });
